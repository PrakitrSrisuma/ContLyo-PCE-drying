...
ip.rhoi = 917;  % density of the frozen region (kg/m3)
...
ip.ki = 2.25;  % thermal conductivity of the frozen region (W/mK)
...
% VISF freezing
ip.Mw = 18;  % molecular weight of water
ip.MN2 = 28;  % molecular weight of nitrogen, inert
...
ip.Ea = 20500;  % activation energy (J/mol)
ip.fa = .42;  % frequency factor (1/s)
...
ip.tol = 1e-6;  % tolerance
ip.mr1 = 20;  % number of nodes (freezing, 2D)
ip.mz1 = 20;  % number of nodes (freezing, 2D)
ip.nz2 = 3;  % number of nodes (primary drying)
ip.nz3 = 3;  % number of nodes (secondary drying)
